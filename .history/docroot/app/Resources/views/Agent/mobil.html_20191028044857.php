            ...
            <div class="form-group">
              ...
              <div class="radio-group">
                  <div class="radio-inside">
                      <input type="radio" value="perorang" id="perorang" name="applicant_position">
                      <label for="perorang" class="container"> 
                        <?= $this->translate('perorangan')?>
                      </label>
                  </div>
                  <div class="radio-inside">
                      <input type="radio" value="perusahaan" id="perusahaan" name="applicant_position">
                      <label for="perusahaan" class="container"> 
