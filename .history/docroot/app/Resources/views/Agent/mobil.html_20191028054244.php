        ...
        <fieldset class="form-body--credit">
          ...
          <div id="personal-detail">
            ...
            <div class="form-group">
              ...
              <div>
                  <div>
                      <input type="radio" value="perorang" id="perorang" data-select2-id="perorang" name="applicant_position">
                      <label for="perorang"> 
                        <?= $this->translate('perorangan')?>
                      </label>
                  </div>
                  <div>
                      <input type="radio" value="perusahaan" id="perusahaan" data-select2-id="perusahaan" name="applicant_position">
