            ...
            <form method="POST" id="scholarship" name="scholarship" enctype="multipart/form-data">
                <div class="step-content" id="stepper-csr-1">
                    <div class="form-wrapper">
                        ...
                        <div class="input-text-group">
                            <label id="phone-label" class="input-label"><?= $this->translate("form-hp-csr");?></label>
                        ...
                        <div class="input-text-group">
                            <label id="alt-phone-label" class="input-label"><?= $this->translate("form-hp-alt-csr");?></label>
                        ...
                        <div id="upload">
                            ...
                            <div class="upload-content-wrapper">
                                ...
                                <button id="upload-button" class="btn-upload" onclick="document.getElementById('file-upload').click(); return false;">
                                    ...
                                    <input id="file-upload" class="hide-input formRequired" accept="image/*" type="file" name="photo" id="photo" onchange=" document.getElementById('upload-button').innerHTML = '<?= $this->translate('Change file') ?>';">
                                </div>
                        ...
                        <div id="upload">
                            ...
                            <div class="upload-content-wrapper">
                                <div class="upload-btn-wrapper">
                                    ...
                                    <input id="file-pdf-upload" class="hide-input" type="file" accept="application/pdf" name="transcript" onchange=" document.getElementById('upload-pdf-button').innerHTML = '<?= $this->translate('Change file') ?>';">
                                </div>
                            </div>
                            <div class="error-wrap"></div>
