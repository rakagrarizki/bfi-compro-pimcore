        ...
        <form id="getCredit" class="form-get--credit" action="#">
            ...
            <fieldset>
                ...
                <div id="formStep1" class="form-body--credit">
                    <div class="text-head">
                        <h1 class="text-center"><?= $this->translate('data-name'), $this->translate('data-agent-motor') ?></h1>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group formRequired">
                            <div class="radio-inside">
                                ...
                                <label for="yes-financing"><?= $this->translate('yes') ?></label>
                            </div>
                            <div class="radio-inside">
                                <input type="radio" value="0" id="not-financing" name="financing">
                                <label for="not-financing"><?= $this->translate('no') ?></label>
                            </div>
                        </div>
                        <div class="error-wrap"></div>
                    </div>
