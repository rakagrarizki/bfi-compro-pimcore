        ...
        <form id="getCredit" class="form-get--credit" action="#">
            ...
            <fieldset>
                ...
                <div id="formStep1" class="form-body--credit">
                    <div class="text-head">
                        <h2 class="text-center"><?= $this->translate('data-name'), $this->translate('data-agent-rumah') ?></h2>
                    ...
                    <div id="personal-detail" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control formRequired formNoKtp" maxlength="16" minlength="16" name="noKtp" id="noKtp" placeholder="<?= $this->translate('label-ktp'); ?>">
                            <div class="error-wrap"></div>
                        </div>
                        ...
                        <div class="form-group" id="frmAreCode">
                            ...
                            <input type="text" class="form-control" disabled name="areCode" id="areCode" placeholder="<?= $this->translate('placeholder-areCode') ?>">
                            <div class="error-wrap"></div>
                        </div>
                    ...
                    <div class="biaya-agunan">
                        <div class="cont-agunan">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td><b><?= $this->translate('label-ktp') ?></b></td>
