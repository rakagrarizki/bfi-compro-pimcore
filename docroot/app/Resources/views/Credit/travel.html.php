          ...
          <div class="form-body--credit-simulasi row">
              ...
              <div class="col-md-6">
                  ...
                  <div class="form-group sliderGroup inputsimulasi">
                      ...
                      <div class="input-group inputform">
                          <span class="input-group-addon" id="basic-addon1">Rp</span>
                          <input type="tel" pattern="\d*" id="down_payment" class="form-control formRequired c-input-trans formatRibuan" style="text-align: right;"
                                  aria-describedby="basic-addon1">
                  ...
                  <div class="form-group sliderGroup inputsimulasi">
                      ...
                      <div class="input-group inputform">
                          <span class="input-group-addon" id="basic-addon1">Rp</span>
                          <input type="tel" pattern="\d*" id="pocket_money" class="form-control formRequired formatRibuan c-input-trans" style="text-align: right;"
                                  aria-describedby="basic-addon1">
                  ...
                  <div class="rincian">
                      ...
                      <div class="total-estimate total-estimate-travel">
                          ...
                          <button class="cta cta-primary cta-big absolutebutcalc" id="recalc"
                                  type="button"><?= $this->translate('count-installment')?></button>
                      </div>
                  </div>
              </div>
