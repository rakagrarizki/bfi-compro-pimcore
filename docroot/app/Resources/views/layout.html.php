...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?=\Pimcore\Tool::getHostUrl().'/favicon/favicon.png'?>"/>
    <link rel="shortcut icon" type="image/png" href="<?=\Pimcore\Tool::getHostUrl().'/favicon/favicon.png'?>"/>
...
<body>
    ...
    <script src="http://maps.google.com/maps/api/js?libraries=places,geometry&key=AIzaSyAd5-VfeP_L4EzX9HwrFsSP9ETaaAXEC3U&region=id&language=id&libraries=geometry,places&sensor=true"></script>
