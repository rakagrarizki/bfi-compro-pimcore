...
const getNeedList = () => {
    ...
    const values = [
        {
            id: "Barang Modal Usaha",
            text: "Barang Modal Usaha",
        },
        {
            id: "Bahan Baku Bangunan",
            text: "Bahan Baku Bangunan",
        },
        {
            id: "Hewan Ternak",
            text: "Hewan Ternak",
...
const saveDataStep4 = function (fn) {
    ...
    $.ajax({
        type: "POST",
        url: "/syariah/save-myfaedah-step4",
        data: data,
        dataType: "json",
        tryCount: 0,
        retryLimit: retryLimit,
...
const saveDataStep5 = function (fn) {
    ...
    $.ajax({
        type: "POST",
        url: "/syariah/save-myfaedah-step5",
        data: data,
        dataType: "json",
        tryCount: 0,
        retryLimit: retryLimit,
