...
class SendApiDummy
{
    ...
    public function getProvince($url)
    {
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "EA12EA20-40ED-466F-9A3B-94067C55580F",
                "desc" => "DKI Jakarta"
            ]
        ];
        $result = json_encode($data);
    ...
    public function getCity($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "5F28B2A1-1968-4251-B52A-0179B1017AD9",
                "desc" => "Palmerah"
            ]
        ];
        $result = json_encode($data);
    ...
    public function getDistrict($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "F1B6255F-7571-4C4B-A5BB-1F826BFFB1EC",
                "desc" => "Jakarta Barat"
            ]
        ];
        $result = json_encode($data);
    ...
    public function getSubdistrict($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "141D34C3-784D-4E21-82B2-23BB2EF61A24",
    ...
    public function getZipcode($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "0706E029-23DE-47FE-99DE-1C604B9D03ED",
                "desc" => "11420"
            ]
        ];
        $result = json_encode($data);
    ...
    public function getCar($url)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "72D6FB87-10FC-4316-ABEC-45A48D725328",
                "desc" => "Sedan"
            ]
        ];
        $result = json_encode($data);
    ...
    public function getCarBrand($url)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "6A939796-1738-4CF5-B6E5-C02550CB9ABD",
                "desc" => "MERCEDES"
            ]
        ];
        $result = json_encode($data);
    ...
    public function getCarModel($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "18F4F1C0-4A69-4727-8D40-1F83F7708E2D",
    ...
    public function getCarYear($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "A6524ACC-EFBA-4B71-A88E-DDD990D7C305",
                "desc" => "2018"
            ]
        ];
        $result = json_encode($data);
    ...
    public function saveCarLeads1($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_custumer_id" => "9F3E1CFC-FE88-4DD4-98DD-FCE02F38104E",
    ...
    public function saveCarLeads2($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_address_id" => "647AF464-93D0-4708-9903-1A744915D305",
    ...
    public function getMotorcycle($url)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "D2962CBA-E4C6-404A-ADDD-2A962D12329F",
                "desc" => "Bebek"
            ]
        ];
        $result = json_encode($data);
    ...
    public function getMotorcycleBrand($url)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "84DB5FD8-43B2-4FA4-BA0F-414D9960600A",
                "desc" => "HONDA"
            ]
        ];
        $result = json_encode($data);
    ...
    public function getMotorcycleModel($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "3F2F23BC-658E-4FAC-B2FD-00B54420C69E",
                "desc" => "NEW PCX 150"
            ]
        ];
        $result = json_encode($data);
    ...
    public function getMotorcycleYear($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "26A00859-9825-4562-89ED-7C3BF717E640",
                "desc" => "2018"
            ]
        ];
        $result = json_encode($data);
    ...
    public function saveMotorcycleLeads1($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_custumer_id" => "2E02E3B3-4A77-4BF0-9F8C-72929B2FFDF3",
    ...
    public function saveMotorcycleLeads2($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_address_id" => "6C015215-C722-4DC7-B752-A9B2D4DF1AF3",
    ...
    public function savePbfLeads1($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_custumer_id" => "D30205D7-948B-4F39-A27C-E735714740A8",
    ...
    public function savePbfLeads2($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_address_id" => "88A339A8-9A4B-4D93-B9DB-504703CFDE01",
    ...
    public function saveLeisureLeads1($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_custumer_id" => "9B332AB2-49D3-4FBC-BBF4-8ED9CB13510E",
    ...
    public function saveLeisureLeads2($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_address_id" => "56FD2FE5-D234-46BA-BAA5-67595A5FFA9E",
                "submission_id" => "9014818F-329D-4E4F-A73E-FBBE6678F088"
            ]
        ];
        $result = json_encode($data);
    ...
    public function saveEduLeads1($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_custumer_id" => "C4A18D41-E1A7-4078-9A90-870C46590B30",
    ...
    public function saveEduLeads2($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_address_id" => "34D2D46F-C16E-4336-9006-412BD6D40667",
                "submission_id" => "357351FE-E470-4B6A-AD57-7609D926AFA9"
            ]
        ];
        $result = json_encode($data);
    ...
    public function getMachineryYear($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "id" => "5BD13C25-2AEC-459E-A5CD-FB1B8AC0EFBE",
                "year" => "2019"
            ]
        ];
        $result = json_encode($data);
    ...
    public function getMachineryFunding($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_id" => "935B0633-7466-433F-BA54-1E29D433E8D8",
    ...
    public function saveMachineryLeads1($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_custumer_id" => "1B4F3267-D54D-4C9B-8AD6-C5FAF05F1C81",
    ...
    public function saveMachineryLeads2($url, $params)
    {
        ...
        $data = [
            ...
            'status' => "success",
            'data' => [
                "submission_address_id" => "3EF9D783-BEB1-4DE7-B031-449C5162FCB1",
                "submission_id" => "162B8214-9FB9-492E-9AED-F52CC1F9C756"
            ]
        ];
        $result = json_encode($data);
